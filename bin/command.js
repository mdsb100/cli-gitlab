...
var issues, packageInfo, program, projects, tablehead, users, worker;
...
issues = program.command("issues").description("Get issues from gitlab").action(function(cmd) {
  var argLen, options;
  argLen = arguments.length;
  if (typeof arguments[0] === "object") {
    cmd = null;
